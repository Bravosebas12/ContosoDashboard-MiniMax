...
namespace ContosoDashboard.Migrations
{
    ...
    [Migration("20260612180018_InitialDocuments")]
            ...
            modelBuilder.Entity("ContosoDashboard.Models.Document", b =>
                {
                    ...
                    b.Property<DateTime?>("AvScanAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("AvScanStatus")
                        .HasColumnType("int");

                    b.Property<string>("AvThreatName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.HasIndex("UploadedAt", "DocumentId");
